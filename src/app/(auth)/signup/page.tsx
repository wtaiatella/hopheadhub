  ...
  return (
    <>
      ...
      <div className="bg-background px-12 py-8">
        ...
        <h1 className="text-3xl font-bold text-primary my-8">Welcome to your beer community!</h1>
        ...
        <div className="text-center mt-2">
          <p>
            ...
            <a href="/signin" className="text-primary hover:text-primary-hover hover:underline">
              Sign in here
            </a>
          </p>
        </div>
