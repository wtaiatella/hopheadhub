      ...
      >
        <Card className="mb-6">
          ...
          <div className="flex justify-center">
            ...
            >
              {imageUrl ? (
                <img src={imageUrl} alt="avatar" style={{ width: "100%" }} className="rounded-full" />
              ) : (
                uploadButton
              )}
            </Upload>
        ...
        <div className="flex justify-start">
          <Button type="primary" htmlType="submit" size="large" className="bg-indigo-800 hover:bg-indigo-700">
            Save My Profile
          </Button>
        </div>
      </Form>
