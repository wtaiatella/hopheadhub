    ...
    <div className="max-w-4xl mx-auto">
      ...
      <Card className="mb-6">
        <div className="flex justify-between items-center mb-4">
          <Title level={4} className="mb-0">Change Email</Title>
          ...
          <div className="grid grid-cols-1 gap-4">
            <Form.Item label="Current Email:">
              <Input 
                value={currentEmail} 
                readOnly 
                suffix={<Badge count={<CheckCircleOutlined style={{ color: '#52c41a' }} />} />}
            ...
            >
              <Input 
                ...
                suffix={
                  <Button type="link" onClick={sendVerificationLink} className="p-0 h-auto">
      ...
      <Card className="mb-6">
        <div className="flex justify-between items-center mb-4">
          <Title level={4} className="mb-0">Change Phone Number</Title>
          <Button type="text" icon={<PlusOutlined />} />
        </div>
        <Form
          form={phoneForm}
