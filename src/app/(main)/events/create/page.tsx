            ...
            <div>
              ...
              <div className="flex items-center gap-4 w-full justify-between">
                ...
                <Form.Item
                  ...
                  rules={[{ required: true, message: 'Please enter the event address number' }]}
                  labelCol={{ span: 24 }}
                >
                ...
                <Form.Item
                  ...
                  label="Complement"
                  rules={[{ required: true, message: 'Please enter the event complement' }]}
                  labelCol={{ span: 24 }}
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              >
                <div className="flex flex-col items-center justify-center p-4">
                  ...
                  <p className="text-gray-500 text-center">My event requires tickets for entry</p>
                </div>
              </Card>
                  ...
                  <div key={index} className="flex flex-wrap gap-4 items-end">
                    ...
                    >
                      <Input
                        ...
                        addonBefore="$"
                        value={ticket.price}
                        onChange={e => handleTicketPriceChange(index, Number(e.target.value))}
                      />
                    </Form.Item>
                  </div>
                ))}
                <Button type="dashed" onClick={addTicket} icon={<Plus />} className="w-full">
                  Add Ticket Type
                </Button>
              </div>
            )}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  {ticketType === 'ticketed' && (
                    <div>
                      ...
                      <div className="flex items-center gap-2 text-gray-600">
                        <span>🎟️</span>
                        <span>Ticket Type: {tickets.map(t => t.name || 'Ticket').join(', ')}</span>
                      </div>
                      <div className="flex items-center gap-2 text-gray-600">
                        <span>💰</span>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="flex gap-2 mt-1">
                        <button className="bg-gray-200 text-xs px-2 py-1 rounded">Contact</button>
